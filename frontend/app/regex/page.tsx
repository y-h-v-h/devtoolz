    ...
    <section className="flex min-h-screen w-full flex-col items-stretch lg:flex-row">
      ...
      <section className="relative shrink-0 overflow-hidden px-6 pb-10 lg:w-[400px] lg:min-w-[400px] lg:px-12 lg:py-14 xl:w-[500px]">
        ...
        <p className="py-2 text-sm leading-8 text-zinc-500">
          ...
          markdown editor. Which is the best markdown editor/library for react?
          preferably something with Code support. I have kept this one in mind,
          I was just looking if there was any other better library that I'm not
          aware about. Thanks for the suggestion!
        </p>
      </section>
    </section>
  );
